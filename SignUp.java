...
public class SignUp{
    ...
    private String fileName,name,password,mobileNumber,age,bloodGroup,district;
    private String [] bloodGroupList= new String[]{"A+","B+","AB+","O+","A-","B-","AB-","O-"};
    private String [] districtList=new String[]{"Dhaka","Jashore","Comilla","chittagog","Faridpur","Gazipur","Gopalgan","Kishorega","Madaripur","Manikganj","Munshiganj","Narayanganj","Narsingdi","Rajbari","hariatpur","angail","andarban","Brahmanbari","Chandpur","Chattogram","Cox’s Bazar","Cumilla","Feni","Khagrachhar","Lakshmipur","Noakhali","Rangamati"," Habiganj","Moulvibazar","Sunamganj","Sylhet","Barguna"," Barishal","Bhola","Jhalokati","Patuakhali","Pirojpur","Bagerhat","Chuadanga","Jashore","Jhenaidah","Jhenaidah","Khulna","Kushtia","Magura","Meherpur","Narail","Satkhira","Bogura","Joypurhat","Naogaon","Natore","Chapainawab"," Pabna","Rajshahi","Sirajganj"," Dinajpur","Gaibandha","Kurigram","Lalmonirhat","Nilphamari","Panchagarh","Rangpur","Thakurgaon","Jamalpur","Mymensing","Netrokona"};
...
//Blood Group:
        ...
        cb1= new JComboBox (bloodGroupList);
        cb1.setBounds(x+80,y+160,110,30);
        cb1.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                bloodGroup=cb1.getSelectedItem().toString();
            }
        });
//Password:
